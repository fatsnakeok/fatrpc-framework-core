...
public class JavassistDemo {
    ...
    public static final String DEMO_CLASS = "org.fatsnake.fatrpc.framework.core.proxy.javassist.demo.Demo";
    ...
    public static void createProxyObject() throws Exception {
        ClassPool classPool = ClassPool.getDefault();
        CtClass newClass = classPool.makeClass("org.fatsnake.fatrpc.framework.core.proxy.javassist.NewDemoObject");
